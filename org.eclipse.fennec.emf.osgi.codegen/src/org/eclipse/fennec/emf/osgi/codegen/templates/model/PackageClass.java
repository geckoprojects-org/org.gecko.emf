package org.eclipse.fennec.emf.osgi.codegen.templates.model;
...
public class PackageClass
{
  ...
  protected final String TEXT_78 = "#eNS_URI" + NL + "\t * @see #init()" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_79 = "public";
  protected final String TEXT_80 = "private";
  protected final String TEXT_81 = "()" + NL + "\t{" + NL + "\t\tsuper(eNS_URI, ";
  protected final String TEXT_82 = ");" + NL + "\t}";
  protected final String TEXT_83 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate static boolean isInited = false;" + NL;
  protected final String TEXT_84 = NL + "\t/**" + NL + "\t * Creates, registers, and initializes the <b>Package</b> for this model, and for any others upon which it depends." + NL + "\t *" + NL + "\t * <p>This method is used to initialize {@link ";
  protected final String TEXT_85 = "#eINSTANCE} when that field is accessed." + NL + "\t * Clients should not invoke it directly. Instead, they should simply access that field to obtain the package." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see #eNS_URI";
  protected final String TEXT_86 = NL + "\t * @see #createPackageContents()" + NL + "\t * @see #initializePackageContents()";
  protected final String TEXT_87 = NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static ";
  protected final String TEXT_88 = " init()" + NL + "\t{";
  protected final String TEXT_89 = NL + "\t\t// Initialize the family head to initialize the entire family" + NL + "\t\t";
  protected final String TEXT_90 = ".eINSTANCE.eClass();" + NL + "\t\treturn (";
  protected final String TEXT_91 = ")";
  protected final String TEXT_92 = ".Registry.INSTANCE.getEPackage(";
  protected final String TEXT_93 = ".eNS_URI);";
  protected final String TEXT_94 = NL + "\t\tif (isInited) return (";
  protected final String TEXT_95 = ".eNS_URI);" + NL;
  protected final String TEXT_96 = NL + "\t\tinitializeRegistryHelpers();" + NL;
  protected final String TEXT_97 = NL + "\t\t// Obtain or create and register package" + NL + "\t\tObject registered";
  protected final String TEXT_98 = ".Registry.INSTANCE.get(eNS_URI);" + NL + "\t\t";
  protected final String TEXT_99 = " the";
  protected final String TEXT_100 = " = registered";
  protected final String TEXT_101 = " instanceof ";
  protected final String TEXT_102 = " ? (";
  protected final String TEXT_103 = ")registered";
  protected final String TEXT_104 = " : new ";
  protected final String TEXT_105 = "();" + NL + "" + NL + "\t\tisInited = true;" + NL;
  protected final String TEXT_106 = NL + "\t\t// Initialize simple dependencies";
  protected final String TEXT_107 = NL + "\t\t";
  protected final String TEXT_108 = ".eINSTANCE.eClass();";
  protected final String TEXT_109 = NL + "\t\t// Obtain or create and register interdependencies";
  protected final String TEXT_110 = "Object ";
  protected final String TEXT_111 = "registeredPackage = ";
  protected final String TEXT_112 = ".Registry.INSTANCE.";
  protected final String TEXT_113 = "get";
  protected final String TEXT_114 = "getEPackage";
  protected final String TEXT_115 = "(";
  protected final String TEXT_116 = ".eNS_URI);" + NL + "\t\t";
  protected final String TEXT_117 = " = (";
  protected final String TEXT_118 = ")(registeredPackage instanceof ";
  protected final String TEXT_119 = " ? registeredPackage : ";
  protected final String TEXT_120 = "new ";
  protected final String TEXT_121 = ".eINSTANCE";
  protected final String TEXT_122 = ");";
  protected final String TEXT_123 = NL + "\t\t// Load packages";
  protected final String TEXT_124 = NL + "\t\tthe";
  protected final String TEXT_125 = ".loadPackage();";
  protected final String TEXT_126 = NL + "\t\t// Create package meta-data objects";
  ...
  protected final String TEXT_132 = NL + "\t\t// Register package validator" + NL + "\t\t";
  protected final String TEXT_133 = ".Registry.INSTANCE.put" + NL + "\t\t\t(the";
  protected final String TEXT_134 = "," + NL + "\t\t\t new ";
  ...
  protected final String TEXT_140 = NL + "\t\t// Freeze and register the family tree packages.";
  protected final String TEXT_141 = ".freeze();" + NL + "\t\t";
  protected final String TEXT_142 = ".Registry.INSTANCE.put(";
  protected final String TEXT_143 = ".eNS_URI, ";
  protected final String TEXT_144 = NL + "\t\t// Mark meta-data to indicate it can't be changed" + NL + "\t\tthe";
  protected final String TEXT_145 = ".freeze();" + NL;
  protected final String TEXT_146 = NL + "\t\t// Update the registry and return the package" + NL + "\t\t";
  protected final String TEXT_147 = ".eNS_URI, the";
  protected final String TEXT_148 = ");" + NL + "\t\treturn the";
  protected final String TEXT_149 = NL + "\t}";
  protected final String TEXT_150 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static void initializeRegistryHelpers()" + NL + "\t{";
  protected final String TEXT_151 = ".register" + NL + "\t\t\t(";
  protected final String TEXT_152 = ".class," + NL + "\t\t\t new ";
  protected final String TEXT_153 = ".Helper()" + NL + "\t\t\t {" + NL + "\t\t\t\t public boolean isInstance(Object instance)" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return instance instanceof ";
  protected final String TEXT_154 = ";" + NL + "\t\t\t\t }" + NL + "" + NL + "\t\t\t\t public Object newArrayInstance(int size)" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return new ";
  protected final String TEXT_155 = "[size];" + NL + "\t\t\t\t }" + NL + "\t\t\t });";
  protected final String TEXT_156 = ";" + NL + "\t\t\t\t }" + NL + "" + NL + "\t\t\t\t public Object newArrayInstance(int size)" + NL + "\t\t\t\t {";
  ...
  protected final String TEXT_161 = NL + "\t}" + NL + "" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static class WhiteList implements ";
  protected final String TEXT_162 = ", EBasicWhiteList" + NL + "\t{";
  protected final String TEXT_163 = NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\tprotected ";
  protected final String TEXT_164 = NL + "\t * Returns the meta object for class '{@link ";
  protected final String TEXT_165 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for class '<em>";
  protected final String TEXT_166 = "</em>'." + NL + "\t * @see ";
  protected final String TEXT_167 = NL + "\t * @model ";
  protected final String TEXT_168 = NL + "\t *        ";
  protected final String TEXT_169 = NL + "\t * @model";
  protected final String TEXT_170 = NL + "\t * Returns the meta object for enum '{@link ";
  protected final String TEXT_171 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for enum '<em>";
  protected final String TEXT_172 = NL + "\t * Returns the meta object for data type '<em>";
  protected final String TEXT_173 = "</em>'.";
  protected final String TEXT_174 = NL + "\t * Returns the meta object for data type '{@link ";
  protected final String TEXT_175 = "</em>}'.";
  protected final String TEXT_176 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_177 = NL + "     * <!-- begin-model-doc -->" + NL + "     * ";
  protected final String TEXT_178 = NL + "     * <!-- end-model-doc -->";
  protected final String TEXT_179 = NL + "\t * @return the meta object for data type '<em>";
  ...
  protected final String TEXT_191 = NL + "\t/**" + NL + "\t * Returns the meta object for the ";
  ...
  protected final String TEXT_203 = NL + "\t/**" + NL + "\t * Returns the meta object for the '{@link ";
  protected final String TEXT_204 = ") <em>";
  protected final String TEXT_205 = "</em>}' operation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the '<em>";
  protected final String TEXT_206 = "</em>' operation." + NL + "\t * @see ";
  protected final String TEXT_207 = ".getEOperations().get(";
  protected final String TEXT_208 = NL + "        return get";
  protected final String TEXT_209 = "().getEOperations().get(";
  ...
  protected final String TEXT_212 = "()" + NL + "\t{" + NL + "\t\treturn (";
  protected final String TEXT_213 = ")getEFactoryInstance();" + NL + "\t}";
  protected final String TEXT_214 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isCreated = false;" + NL + "" + NL + "\t/**" + NL + "\t * Creates the meta-model objects for the package.  This method is" + NL + "\t * guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_215 = NL + "\t@SuppressWarnings(\"deprecation\")";
  protected final String TEXT_216 = NL + "\tpublic void createPackageContents()" + NL + "\t{" + NL + "\t\tif (isCreated) return;" + NL + "\t\tisCreated = true;";
  protected final String TEXT_217 = NL + NL + "\t\t// Create classes and their features";
  protected final String TEXT_218 = " = create";
  protected final String TEXT_219 = NL + "\t\tcreate";
  protected final String TEXT_220 = ", ";
  protected final String TEXT_221 = NL + "\t\tcreateEOperation(";
  protected final String TEXT_222 = NL + NL + "\t\t// Create enums";
  protected final String TEXT_223 = " = createEEnum(";
  protected final String TEXT_224 = NL + NL + "\t\t// Create data types";
  protected final String TEXT_225 = " = createEDataType(";
  protected final String TEXT_226 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isInitialized = false;" + NL;
  protected final String TEXT_227 = NL + "\t/**" + NL + "\t * Complete the initialization of the package and its meta-model.  This" + NL + "\t * method is guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_228 = NL + "\tpublic void initializePackageContents()" + NL + "\t{" + NL + "\t\tif (isInitialized) return;" + NL + "\t\tisInitialized = true;" + NL + "" + NL + "\t\t// Initialize package" + NL + "\t\tsetName(eNAME);" + NL + "\t\tsetNsPrefix(eNS_PREFIX);" + NL + "\t\tsetNsURI(eNS_URI);";
  protected final String TEXT_229 = NL + NL + "\t\t// Obtain other dependent packages";
  protected final String TEXT_230 = NL + NL + "\t\t// Add subpackages";
  protected final String TEXT_231 = NL + "\t\tgetESubpackages().add(";
  protected final String TEXT_232 = NL + NL + "\t\t// Create type parameters";
  protected final String TEXT_233 = "_";
  protected final String TEXT_234 = " = addETypeParameter(";
  protected final String TEXT_235 = ", \"";
  protected final String TEXT_236 = "\");";
  protected final String TEXT_237 = NL + "\t\taddETypeParameter(";
  protected final String TEXT_238 = NL + NL + "\t\t// Set bounds for type parameters";
  protected final String TEXT_239 = "g";
  protected final String TEXT_240 = " = createEGenericType(";
  protected final String TEXT_241 = NL + "\t\tg";
  protected final String TEXT_242 = ".";
  protected final String TEXT_243 = "(g";
  protected final String TEXT_244 = ".getEBounds().add(g1);";
  protected final String TEXT_245 = NL + NL + "\t\t// Add supertypes to classes";
  protected final String TEXT_246 = ".getESuperTypes().add(";
  protected final String TEXT_247 = ".get";
  protected final String TEXT_248 = "());";
  protected final String TEXT_249 = ".getEGenericSuperTypes().add(g1);";
  protected final String TEXT_250 = NL + NL + "\t\t// Initialize classes";
  protected final String TEXT_251 = ", features, and operations; add parameters";
  protected final String TEXT_252 = " and features; add operations and parameters";
  protected final String TEXT_253 = NL + "\t\tinitEClass(";
  protected final String TEXT_254 = "null";
  protected final String TEXT_255 = ".class";
  protected final String TEXT_256 = "\", ";
  protected final String TEXT_257 = "\"";
  protected final String TEXT_258 = NL + "\t\tinitEReference(get";
  protected final String TEXT_259 = "(), ";
  protected final String TEXT_260 = "g1";
  protected final String TEXT_261 = NL + "\t\tget";
  protected final String TEXT_262 = "().getEKeys().add(";
  protected final String TEXT_263 = NL + "\t\tinitEAttribute(get";
  protected final String TEXT_264 = "initEOperation(get";
  protected final String TEXT_265 = "addEOperation(";
  protected final String TEXT_266 = "(), \"";
  protected final String TEXT_267 = ", null, \"";
  protected final String TEXT_268 = "addETypeParameter(op, \"";
  protected final String TEXT_269 = NL + "\t\tt";
  protected final String TEXT_270 = NL + "\t\taddEParameter(op, ";
  protected final String TEXT_271 = NL + "\t\taddEException(op, g";
  protected final String TEXT_272 = NL + "\t\taddEException(op, ";
  protected final String TEXT_273 = NL + "\t\tinitEOperation(op, g1);";
  protected final String TEXT_274 = NL + NL + "\t\t// Initialize enums and add enum literals";
  protected final String TEXT_275 = NL + "\t\tinitEEnum(";
  protected final String TEXT_276 = ".class, \"";
  protected final String TEXT_277 = NL + "\t\taddEEnumLiteral(";
  protected final String TEXT_278 = NL + NL + "\t\t// Initialize data types";
  protected final String TEXT_279 = NL + "\t\tinitEDataType(";
  protected final String TEXT_280 = NL + NL + "\t\t// Create resource" + NL + "\t\tcreateResource(";
  protected final String TEXT_281 = NL + NL + "\t\t// Create annotations";
  protected final String TEXT_282 = NL + "\t\t// ";
  protected final String TEXT_283 = "Annotations();";
  protected final String TEXT_284 = NL + "\t}" + NL;
  protected final String TEXT_285 = NL + "\t/**" + NL + "\t * Initializes the annotations for <b>";
  protected final String TEXT_286 = "</b>." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected void create";
  protected final String TEXT_287 = "Annotations()" + NL + "\t{" + NL + "\t\tString source = ";
  protected final String TEXT_288 = "null;";
  protected final String TEXT_289 = NL + "\t\taddAnnotation" + NL + "\t\t  (";
  protected final String TEXT_290 = "," + NL + "\t\t   source," + NL + "\t\t   new String[]" + NL + "\t\t   {";
  ...
  protected final String TEXT_297 = ".createURI(";
  protected final String TEXT_298 = "eNS_URI).appendFragment(\"";
  protected final String TEXT_299 = "\")";
  protected final String TEXT_300 = NL + "\t\t   });";
  protected final String TEXT_301 = "," + NL + "\t\t   ";
  protected final String TEXT_302 = "new boolean[] { ";
  protected final String TEXT_303 = " }";
  protected final String TEXT_304 = "null,";
  protected final String TEXT_305 = "\",";
  protected final String TEXT_306 = NL + "\t\t   new String[]" + NL + "\t\t   {";
  protected final String TEXT_307 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isLoaded = false;" + NL + "" + NL + "\t/**" + NL + "\t * Laods the package and any sub-packages from their serialized form." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void loadPackage()" + NL + "\t{" + NL + "\t\tif (isLoaded) return;" + NL + "\t\tisLoaded = true;" + NL + "" + NL + "\t\t";
  protected final String TEXT_308 = " url = getClass().getResource(packageFilename);" + NL + "\t\tif (url == null)" + NL + "\t\t{" + NL + "\t\t\tthrow new RuntimeException(\"Missing serialized package: \" + packageFilename);";
  protected final String TEXT_309 = NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_310 = " uri = ";
  protected final String TEXT_311 = ".createURI(url.toString());" + NL + "\t\t";
  protected final String TEXT_312 = " resource = new ";
  protected final String TEXT_313 = "().createResource(uri);" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\tresource.load(null);" + NL + "\t\t}" + NL + "\t\tcatch (";
  protected final String TEXT_314 = " exception)" + NL + "\t\t{" + NL + "\t\t\tthrow new ";
  protected final String TEXT_315 = "(exception);" + NL + "\t\t}" + NL + "\t\tinitializeFromLoadedEPackage(this, (";
  protected final String TEXT_316 = ")resource.getContents().get(0));" + NL + "\t\tcreateResource(eNS_URI);" + NL + "\t}" + NL;
  protected final String TEXT_317 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isFixed = false;" + NL + "" + NL + "\t/**" + NL + "\t * Fixes up the loaded package, to make it appear as if it had been programmatically built." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void fixPackageContents()" + NL + "\t{" + NL + "\t\tif (isFixed) return;" + NL + "\t\tisFixed = true;" + NL + "\t\tfixEClassifiers();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Sets the instance class on the given classifier." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_318 = NL + "\tprotected void fixInstanceClass(";
  protected final String TEXT_319 = " eClassifier)" + NL + "\t{" + NL + "\t\tif (eClassifier.getInstanceClassName() == null)" + NL + "\t\t{";
  protected final String TEXT_320 = NL + "\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_321 = ".\" + eClassifier.getName());";
  protected final String TEXT_322 = NL + "\t\t\tsetGeneratedClassName(eClassifier);";
  protected final String TEXT_323 = NL + "\t\t\tswitch (eClassifier.getClassifierID())" + NL + "\t\t\t{";
  protected final String TEXT_324 = NL + "\t\t\t\tcase ";
  protected final String TEXT_325 = ":";
  protected final String TEXT_326 = NL + "\t\t\t\t{" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_327 = NL + "\t\t\t\t\tsetGeneratedClassName(eClassifier);" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_328 = NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_329 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_330 = " addEOperation(";
  protected final String TEXT_331 = " owner, ";
  protected final String TEXT_332 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_333 = " o = addEOperation(owner, type, name, lowerBound, upperBound);" + NL + "\t\to.setUnique(isUnique);" + NL + "\t\to.setOrdered(isOrdered);" + NL + "\t\treturn o;" + NL + "\t}" + NL;
  protected final String TEXT_334 = " addEParameter(";
  protected final String TEXT_335 = " p = ecoreFactory.createEParameter();" + NL + "\t\tp.setEType(type);" + NL + "\t\tp.setName(name);" + NL + "\t\tp.setLowerBound(lowerBound);" + NL + "\t\tp.setUpperBound(upperBound);" + NL + "\t\tp.setUnique(isUnique);" + NL + "\t\tp.setOrdered(isOrdered);" + NL + "\t\towner.getEParameters().add(p);" + NL + "\t\treturn p;" + NL + "\t}" + NL;
  protected final String TEXT_336 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * Defines literals for the meta objects that represent" + NL + "\t * <ul>" + NL + "\t *   <li>each class,</li>" + NL + "\t *   <li>each feature of each class,</li>";
  protected final String TEXT_337 = NL + "\t *   <li>each operation of each class,</li>";
  protected final String TEXT_338 = NL + "\t *   <li>each enum,</li>" + NL + "\t *   <li>and each data type</li>" + NL + "\t * </ul>" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_339 = "public ";
  protected final String TEXT_340 = "interface Literals" + NL + "\t{";
  protected final String TEXT_341 = NL + "\t\t/**";
  protected final String TEXT_342 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_343 = "</em>}' class." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_344 = "</em>}' enum." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_345 = NL + "\t\t * The meta object literal for the '<em>";
  protected final String TEXT_346 = "</em>' data type." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_347 = NL + "\t\t * @see ";
  protected final String TEXT_348 = NL + "\t\t * ";
  protected final String TEXT_349 = NL + "\t\t * @generated" + NL + "\t\t */";
  protected final String TEXT_350 = NL + "\t\t@Deprecated";
  protected final String TEXT_351 = " = eINSTANCE.get";
  protected final String TEXT_352 = NL + "\t\t/**" + NL + "\t\t * The meta object literal for the '<em><b>";
  protected final String TEXT_353 = " feature." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_354 = "</b></em>' operation." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
